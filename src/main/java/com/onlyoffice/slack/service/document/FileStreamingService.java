...
public class FileStreamingService implements DocumentFileStreamingService {
  ...
  private void validateFileSize(final File file) {
    ...
    if (file.getSize() <= 0) throw new FileSizeException("File size is less or equal to 0 bytes");
  }
