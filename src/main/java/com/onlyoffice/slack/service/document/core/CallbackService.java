...
public class CallbackService implements DocumentCallbackService {
  ...
  private final DocumentServerCallbackRegistry callbackRegistry;
  ...
  public void processCallback(
    ...
    try {
      ...
      var validatedCallback =
          jwtManagerService.verifyToken(callback.getToken(), settings.getSecret());
