...
public class FileManagerService implements DocumentFileManagerService {
  private static final String DOWNLOAD_PATTERN = "%s/download/%s";
    ...
    try {
      ...
      var document =
          Document.builder()
              ...
              .title(file.getName())
              .url(
                  DOWNLOAD_PATTERN.formatted(serverConfigurationProperties.getBaseAddress(), token))
