...
import com.onlyoffice.slack.exception.DocumentJwtValidationException;
...
public class JwtManagerService implements DocumentJwtManagerService {
  ...
  public Map<String, Object> verifyToken(@NotBlank String token, @NotBlank String key) {
    try {
      ...
      throw new DocumentJwtValidationException("Failed to verify and parse JWT token", e);
    }
  }
}
