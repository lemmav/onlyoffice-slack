...
@Getter
@Component
class DocumentCallbackRegistryImpl implements DocumentCallbackRegistry {
  private final Map<Status, TriFunction<String, String, Callback, Callback>> registry =
      new HashMap<>();

  @Autowired
  public DocumentCallbackRegistryImpl(final List<DocumentCallbackRegistrar> registrars) {
